...
The pre-engagement phase established our testing scope, rules of engagement, and boundaries. This legal and ethical framework ensures our testing activities remain authorized and focused on demonstrating risk rather than causing harm. Clear scoping prevents misunderstandings and keeps both testers and clients protected.

Through reconnaissance, we leveraged OSINT techniques to gather intelligence without touching Hiboxy's systems directly. Social media revealed employee information, breached credential databases provided potential passwords, and public records exposed email formats and infrastructure details. This passive intelligence gathering phase is often overlooked by defenders but provides attackers with crucial targeting information.

Our network scanning workflow progressed from broad to focused. We first identified Hiboxy's network ranges through reverse DNS lookups and other discovery methods. Masscan allowed us to rapidly scan all TCP ports across these ranges, identifying active hosts and services. These results then fed into more detailed Nmap scans for service enumeration and OS fingerprinting. We also discovered Hiboxy's Azure adoption, showing that modern organizations often have infrastructure spanning both on-premises and cloud environments.

Our next section, SEC560.2, will build on this foundation with initial access techniques.
