...
# Command - docker - docker compose - マルチコンテナアプリケーションを定義・実行する
...
| コマンド | 概要 | 詳細 |
| :--- | :--- | :--- |
| ⭐ **`docker compose up`** | サービスをビルド、作成、**起動**する | [./docker_compose_up.md](Command%20-%20docker%20-%20docker%20compose%20up%20-%20Composeアプリケーションをビルド・作成・起動する.md) |
| ⭐ **`docker compose down`**| サービスに関連するコンテナ、ネットワーク等を**停止・削除**する | [./docker_compose_down.md](Command%20-%20docker%20-%20docker%20compose%20down%20-%20Composeアプリケーションを停止・削除する.md) |
| ⭐ **`docker compose ps`** | プロジェクトのコンテナ**一覧を表示**する | [./docker_compose_ps.md](Command%20-%20docker%20-%20docker%20compose%20ps%20-%20Composeアプリケーションのコンテナ状態を表示する.md) |
| ⭐ **`docker compose logs`**| サービスの**ログを表示**する | [./docker_compose_logs.md](Command%20-%20docker%20-%20docker%20compose%20logs%20-%20Composeアプリケーションのログを表示する.md) |
